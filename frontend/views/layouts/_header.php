            ...
            <div class="top_nav media-body media-middle affix-top">
                <div class="top_nav_wrapper clearfix">
                    <ul id="menu-main-menu" class="main_menu_nav">
                        <li id="menu-item-1290" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1290"><a href="https://shintainserve.com/">Home</a></li>
                        <li id="menu-item-1295" class="menu-item menu-item-type-post_type menu-item-object-page current-page-ancestor current-page-parent menu-item-has-children menu-item-1295"><a href="https://shintainserve.com/company-overview/">About Us</a>
                            <ul class="sub-menu">
                        ...
                        <li id="menu-item-2061" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-344 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-2061"><a href="https://shintainserve.com/company-overview/our-approach/" aria-current="page">Partnership</a>
                            <ul class="sub-menu">
                                <li id="menu-item-1296" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-344 current_page_item menu-item-1296 stm_col_width_default stm_mega_cols_inside_6"><a href="https://shintainserve.com/company-overview/our-approach/" aria-current="page">our approach</a></li>
        ...
        <div class="header_info">
            <div class="top_nav_mobile">
                <ul id="menu-main-menu-1" class="main_menu_nav">
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-1290"><a href="https://shintainserve.com/">Home</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page current-page-ancestor current-page-parent menu-item-has-children menu-item-1295"><a href="https://shintainserve.com/company-overview/">About Us</a><span class="arrow"><i></i></span>
                        <ul class="sub-menu">
                    ...
                    <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-344 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-2061"><a href="https://shintainserve.com/company-overview/our-approach/" aria-current="page">Partnership</a><span class="arrow"><i></i></span>
                        <ul class="sub-menu">
                            <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-344 current_page_item menu-item-1296 stm_col_width_default stm_mega_cols_inside_6"><a href="https://shintainserve.com/company-overview/our-approach/" aria-current="page">our approach</a></li>
                ...
                <div class="wpml-ls-statics-shortcode_actions wpml-ls wpml-ls-legacy-list-horizontal">
                    <ul>
                        <li class="wpml-ls-slot-shortcode_actions wpml-ls-item wpml-ls-item-id wpml-ls-first-item wpml-ls-last-item wpml-ls-item-legacy-list-horizontal">
                            <a href="https://shintainserve.com/id/gambaran-umum-perusahaan/pendekatan-kami/" class="wpml-ls-link">
